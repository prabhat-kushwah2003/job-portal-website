  ...
  return (
    <div className="min-h-screen"> 
      ...
      <div className="shadow py-4 ">
        <div className="px-5 justify-between flex items-center">
          ...
          <div className="flex items-center gap-3">
            <p className="max-sm:hidden ">Welcome, Prabhat</p>
      ...
      <div className="flex items-start">
        ...
        {/*left sidebar with option to add jobs, manage jobs, view appliations */}

        <div className="inline-block min-h-screen border-r-2 text-gray-200 shadow">
